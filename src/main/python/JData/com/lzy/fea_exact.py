...
def gen_vali(month_4=False):
    train = create_feat('2017-1-1','2017-2-1',order,action)
    ...
    train = pd.concat([train,create_feat('2016-9-1','2016-10-1',order,action)])
    
    train.to_csv(r'../input/vali_train.csv',index=None)
    
    test = create_feat('2017-2-1','2017-3-1',order,action)
