...
//    println(findMedianSortedArrays(Array(2), Array(1,3,4,5,6))) //4.0
...
//    if (len1 == 0) {
//      return if (isNum2Odd)  nums2(len2 >> 1 + 1) else (nums2(len2 >> 1)+nums2(len2 >>1 +1)) /2d
//    } else if (len2 == 0) {
//      return if (isNum1Odd)  nums1(len1 >> 1 + 1) else (nums1(len1 >> 1) + nums1(len1>>1 +1))/2d
//    }
//    if (nums1.head > nums2.last) {
//      return if (isNum1Odd && !isNum2Odd)  nums1.head
//      else if (!isNum1Odd && isNum2Odd)  nums2.last
//      else  (nums1.head + nums2.last) / 2d
//    } else if (nums2.head > nums1.last) {
//      return if (isNum1Odd && !isNum2Odd)  nums1.last
//      else if (!isNum1Odd && isNum2Odd)  nums2.head
//      else  (nums1.last + nums2.head) / 2d
//    }
    var i = 0
    var j = 0
